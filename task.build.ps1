...
if ([System.IO.Path]::GetFileName($MyInvocation.ScriptName) -ne 'Invoke-Build.ps1')
{
    ...
    if (-not (Get-InstalledModule InvokeBuild -ErrorAction SilentlyContinue))
    {
       ...
       Write-Host 'Installed and imported InvokeBuild as was not available'
    }
...
Task bootstrap clean, bootstrap-powershell-modules, bootstrap-install-aws-vault, bootstrap-install-serverless-cli
